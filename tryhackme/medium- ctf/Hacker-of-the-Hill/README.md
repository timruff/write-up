...
Avec Burp on lance brute force le nom fichier et on trouve deux fichier que l'on peut lire.  
Api.php et Website.php.   

![page](./Task5-11.png) 

On récupère le contenu de Api.avec burp.  
